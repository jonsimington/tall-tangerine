...
class AI : public Base_ai {
 public:
  /// <summary>
  /// This is a reference to the Game object itself, it contains all the
  /// information about the current game
  /// </summary>
  Game game;

  /// <summary>
  /// This is a pointer to your AI's player. This AI class is not a player, but
  /// it should command this Player.
  /// </summary>
  Player player;
  ...
  // ####################
  /// \cond FALSE
  virtual std::string invoke_by_name(
